...
CREATE TABLE `__new_audit` (
	...
	`created` integer DEFAULT '"2025-09-03T07:27:01.123Z"' NOT NULL,
	`label` text NOT NULL,
	`payload` text
);
...
CREATE TABLE `__new_column` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:27:01.144Z"' NOT NULL,
	`user` text NOT NULL,
	`color` text NOT NULL,
...
CREATE TABLE `__new_customer` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:27:01.129Z"' NOT NULL,
	`name` text NOT NULL,
	`description` text
);
--> statement-breakpoint
...
CREATE TABLE `__new_item` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:27:01.138Z"' NOT NULL,
	`description` text NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_job` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:27:01.134Z"' NOT NULL,
...
CREATE TABLE `__new_job_items` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:27:01.159Z"' NOT NULL,
	`quantity` integer NOT NULL,
...
CREATE TABLE `__new_login` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:27:01.163Z"' NOT NULL,
...
CREATE TABLE `__new_menu` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:27:01.173Z"' NOT NULL,
	`label` text NOT NULL,
...
CREATE TABLE `__new_menugroup` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:27:01.172Z"' NOT NULL,
	`label` text NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_session` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:27:01.153Z"' NOT NULL,
...
CREATE TABLE `__new_user` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:27:01.149Z"' NOT NULL,
	`username` text NOT NULL,
	`password_hash` text NOT NULL,
	`email` text NOT NULL,
