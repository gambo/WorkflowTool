CREATE TABLE `audit` (
	...
	`created` integer DEFAULT '"2025-09-03T07:15:16.757Z"' NOT NULL,
...
CREATE TABLE `__new_column` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:15:16.784Z"' NOT NULL,
	`user` text NOT NULL,
	`color` text NOT NULL,
...
CREATE TABLE `__new_customer` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:15:16.765Z"' NOT NULL,
	`name` text NOT NULL,
	`description` text
);
--> statement-breakpoint
...
CREATE TABLE `__new_item` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:15:16.779Z"' NOT NULL,
	`description` text NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_job` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:15:16.774Z"' NOT NULL,
...
CREATE TABLE `__new_job_items` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:15:16.804Z"' NOT NULL,
	`quantity` integer NOT NULL,
...
CREATE TABLE `__new_login` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:15:16.807Z"' NOT NULL,
...
CREATE TABLE `__new_menu` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:15:16.816Z"' NOT NULL,
	`label` text NOT NULL,
...
CREATE TABLE `__new_menugroup` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:15:16.814Z"' NOT NULL,
	`label` text NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_session` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:15:16.798Z"' NOT NULL,
...
CREATE TABLE `__new_user` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-09-03T07:15:16.793Z"' NOT NULL,
	`username` text NOT NULL,
	`password_hash` text NOT NULL,
	`email` text NOT NULL,
