...
CREATE TABLE `__new_column` (
	...
	`created` integer DEFAULT '"2025-08-31T05:53:07.966Z"' NOT NULL,
	`user` text NOT NULL,
	`color` text NOT NULL,
...
CREATE TABLE `__new_customer` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-08-31T05:53:07.943Z"' NOT NULL,
	`name` text NOT NULL,
	`description` text
);
--> statement-breakpoint
...
CREATE TABLE `__new_item` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-08-31T05:53:07.962Z"' NOT NULL,
	`description` text NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_job` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-08-31T05:53:07.951Z"' NOT NULL,
...
CREATE TABLE `__new_job_items` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-08-31T05:53:08.006Z"' NOT NULL,
	`quantity` integer NOT NULL,
...
CREATE TABLE `__new_login` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-08-31T05:53:08.010Z"' NOT NULL,
...
CREATE TABLE `__new_menu` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-08-31T05:53:08.020Z"' NOT NULL,
	`label` text NOT NULL,
...
CREATE TABLE `__new_menugroup` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-08-31T05:53:08.019Z"' NOT NULL,
	`label` text NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_session` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-08-31T05:53:07.999Z"' NOT NULL,
...
CREATE TABLE `__new_user` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-08-31T05:53:07.993Z"' NOT NULL,
	`username` text NOT NULL,
	`password_hash` text NOT NULL,
	`email` text NOT NULL,
