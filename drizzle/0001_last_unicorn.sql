...
CREATE TABLE `__new_column` (
	...
	`created` integer DEFAULT '"2025-08-30T22:25:18.104Z"' NOT NULL,
	`user` text NOT NULL,
	`color` text NOT NULL,
...
CREATE TABLE `__new_customer` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-08-30T22:25:18.083Z"' NOT NULL,
	`name` text NOT NULL,
	`description` text
);
--> statement-breakpoint
...
CREATE TABLE `__new_item` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-08-30T22:25:18.098Z"' NOT NULL,
	`description` text NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_job` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-08-30T22:25:18.091Z"' NOT NULL,
...
CREATE TABLE `__new_job_items` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-08-30T22:25:18.143Z"' NOT NULL,
	`quantity` integer NOT NULL,
...
CREATE TABLE `__new_login` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-08-30T22:25:18.149Z"' NOT NULL,
...
CREATE TABLE `__new_menu` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-08-30T22:25:18.157Z"' NOT NULL,
	`label` text NOT NULL,
...
CREATE TABLE `__new_menugroup` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-08-30T22:25:18.156Z"' NOT NULL,
	`label` text NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_session` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-08-30T22:25:18.138Z"' NOT NULL,
...
CREATE TABLE `__new_user` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`created` integer DEFAULT '"2025-08-30T22:25:18.132Z"' NOT NULL,
	`username` text NOT NULL,
	`password_hash` text NOT NULL,
	`email` text NOT NULL,
